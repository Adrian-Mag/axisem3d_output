...
def L2_kernel(forward_data_path, backward_data_path, path_to_inversion_mesh, element_output_geometry):
    # Earth's radius in m
    R = 6371000

    # Create element objects
    forward_data = element_output(forward_data_path, element_output_geometry)
    backward_data = element_output(backward_data_path, element_output_geometry)
